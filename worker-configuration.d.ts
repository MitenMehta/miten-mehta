/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=agents/wrangler.jsonc` (hash: 31bba1a912d77e56a4ba19f3e69de37c)
...
interface __BaseEnv_Env {
	...
	WORK_QUEUE: Queue;
	DLQ: Queue;
	MODEL_PRIMARY: "@cf/meta/llama-3.1-8b-instruct";
	MODEL_FALLBACKS: "";
	REQUEST_TIMEOUT_MS: "30000";
	RELEASE_VERSION: "unreleased";
	OIDC_ISSUER: "https://REPLACE_AT_DEPLOY";
	OIDC_AUDIENCE: "virtual-miten";
	OIDC_JWKS_URL: "";
	ORCHESTRAI: Fetcher /* orchestrai-runtime */;
	EWAYA: Fetcher /* ewaya-bridge */;
	WORKFLOW: Workflow<Parameters<import("./agents/src/edge_gateway").OrchestrAIWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./agents/src/edge_gateway");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL_PRIMARY" | "MODEL_FALLBACKS" | "REQUEST_TIMEOUT_MS" | "RELEASE_VERSION" | "OIDC_ISSUER" | "OIDC_AUDIENCE" | "OIDC_JWKS_URL">> {}
}
